...
Instead of just counting these entries, I built a **Python pipeline to audit the AI’s logic**. My goal was to move beyond the raw numbers and find the real story: **What is actually working, what is a "hallucination," and where is the unrealized business value?**

### **1. Normalization**
The AI was creating a new label for almost every variation of a topic (e.g., "PIT safety" vs. "Forklift behavior"). To make this data useful, I consolidated these into **six core categories**. This allowed me to see that while "Other" categories dominate, the **real data lies in Vehicle Operations and Ergonomics**.
