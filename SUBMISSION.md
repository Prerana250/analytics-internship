...
Instead of just counting these entries, I built a **Python pipeline to audit the AI’s logic**. My goal was to move beyond the raw numbers and find out: **What is actually working, what is a hallucination, and where is the unrealized business value?**
